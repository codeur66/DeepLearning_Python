...
def menu():
    ...
    logData = LoggerCls("log_to_file", "start_data_piepeline", dir_path + "/start_data_piepeline.log", "w", formatter,
                        "INFO")
    ...
    try:
        ...
        while choice != "3":
            ...
            if choice == "1":
                logData.info("Creation of data and files from in house text processing.")
                ...
                logData.info("Process data and store files from in house text processing and pretrained model.")
                ...
                embeddings_matrix = ParseWordEmbeddings.create_embeddings_matrix(
                    word_index)  # the pretrainned weights of NN
                ...
                logData.info("Unavailable choice.")
        ...
        logData.error("Probably run out of enough memory for the data processing and storing.")
